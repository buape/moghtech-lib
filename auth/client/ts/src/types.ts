...
export type DeleteSigningKeyResponse = NoData;
 ...
 */
export interface CreateSigningKey {
 ...
 * Response: [NoData].
 */
export interface DeleteSigningKey {
...
export type ManageRequest = 
	...
	| { type: "CreateSigningKey", params: CreateSigningKey }
	| { type: "DeleteSigningKey", params: DeleteSigningKey };
